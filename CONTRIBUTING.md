...
The following is a set of guidelines for contributing to the todo-list-app, which are hosted in the [todo-list-app](https://github.com/oleronrob/todo-list-app) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
